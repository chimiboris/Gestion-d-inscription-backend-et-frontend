...
import com.inscription.app.service.MessageService;
import com.inscription.app.service.dto.MessageDTO;
import com.inscription.app.service.mapper.MessageMapper;
...
class MessageResourceIT {
    ...
    private static final Instant DEFAULT_DATE_ENVOIE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_ENVOIE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().contenu(DEFAULT_CONTENU).dateEnvoie(DEFAULT_DATE_ENVOIE);
        // Add required entity
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().contenu(UPDATED_CONTENU).dateEnvoie(UPDATED_DATE_ENVOIE);
        // Add required entity
        User user = UserResourceIT.createEntity(em);
        em.persist(user);
        em.flush();
    ...
    void createMessage() throws Exception {
        ...
        assertThat(testMessage.getDateEnvoie()).isEqualTo(DEFAULT_DATE_ENVOIE);
    }
    ...
    @Test
    @Transactional
    void checkDateEnvoieIsRequired() throws Exception {
        int databaseSizeBeforeTest = messageRepository.findAll().size();
        // set the field null
        message.setDateEnvoie(null);
    ...
    void putExistingMessage() throws Exception {
        ...
        updatedMessage.contenu(UPDATED_CONTENU).dateEnvoie(UPDATED_DATE_ENVOIE);
        ...
        assertThat(testMessage.getDateEnvoie()).isEqualTo(UPDATED_DATE_ENVOIE);
    }
    ...
    void partialUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.contenu(UPDATED_CONTENU).dateEnvoie(UPDATED_DATE_ENVOIE);
