 ...
 */
type FormValueOf<T extends IMessage | NewMessage> = Omit<T, 'dateEnvoie'> & {
...
type MessageFormDefaults = Pick<NewMessage, 'id' | 'dateEnvoie'>;
...
type MessageFormGroupContent = {
  ...
  dateEnvoie: FormControl<MessageFormRawValue['dateEnvoie']>;
...
export class MessageFormService {
  ...
  private convertMessageRawValueToMessage(rawMessage: MessageFormRawValue | NewMessageFormRawValue): IMessage | NewMessage {
    return {
      ...rawMessage,
      dateEnvoie: dayjs(rawMessage.dateEnvoie, DATE_TIME_FORMAT),
    };
  }
  ...
  private convertMessageToMessageRawValue(
    ...
    return {
      ...message,
      dateEnvoie: message.dateEnvoie ? message.dateEnvoie.format(DATE_TIME_FORMAT) : undefined,
    };
  }
}
