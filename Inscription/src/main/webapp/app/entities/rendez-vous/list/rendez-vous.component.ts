...
import { EntityArrayResponseType, RendezVousService } from '../service/rendez-vous.service';
...
export class RendezVousComponent implements OnInit {
  ...
  trackId = (_index: number, item: IRendezVous): number => this.rendezVousService.getRendezVousIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.rendezVous = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IRendezVous[] | null): IRendezVous[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.rendezVousService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
