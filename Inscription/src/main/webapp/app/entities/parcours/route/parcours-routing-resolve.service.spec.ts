...
import parcoursResolve from './parcours-routing-resolve.service';

describe('Parcours routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: ParcoursService;
  let resultParcours: IParcours | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IParcours returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        parcoursResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultParcours).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IParcours>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
