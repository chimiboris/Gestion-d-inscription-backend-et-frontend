...
describe('Parcours Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'parcours', component: ParcoursComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to parcoursService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getParcoursIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getParcoursIdentifier).toHaveBeenCalledWith(entity);
