...
public class MailService {
    ...
    @Async
    public void sendDossierStatutEmail(User user, String statut, String commentaire, String nomComplet) {
        Locale locale = Locale.forLanguageTag(user.getLangKey());
        Context context = new Context(locale);
        context.setVariable("user", user);
        ...
        context.setVariable("nomComplet", nomComplet); // ✅ Ajout du nom complet

        String content = templateEngine.process("mail/statutUpdateEmail", context);
        String subject = messageSource.getMessage("email.dossier.status.title", null, locale);
        this.sendEmail(user.getEmail(), subject, content, false, true);
    }

//    public void sendDossierStatutEmail(User user, String statut, String commentaire) {
//        Locale locale = Locale.forLanguageTag(user.getLangKey());
//        Context context = new Context(locale);
//        context.setVariable("user", user);
//        context.setVariable("statut", statut);
