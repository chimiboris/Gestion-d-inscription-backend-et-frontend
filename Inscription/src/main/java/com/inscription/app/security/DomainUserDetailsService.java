...
//            .findOneByLogin(usernameOrEmail.toLowerCase())
//            .or(() -> userRepository.findOneByEmailIgnoreCase(usernameOrEmail))
//            .map(user -> createSpringSecurityUser(usernameOrEmail, user))
//            .orElseThrow(() -> new UsernameNotFoundException("User " + usernameOrEmail + " was not found"));
//    }
